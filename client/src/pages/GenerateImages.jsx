...
const GenerateImages = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Generate a high-quality, detailed image of ${input}, in the style of ${selectedStyle}. 
      Make it visually appealing, well-lit, and professional-looking.`;
